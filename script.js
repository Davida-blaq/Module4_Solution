...
(function() {
  ...
  // Loop over the names array and greet each name
  for (var i = 0; i < names.length; i++) {
    var name = names[i];
    var firstLetter = name.charAt(0).toLowerCase();

    // Compare the first letter to lowercase 'j' and call the appropriate speak method
    if (firstLetter === 'j') {
...
// for (/* fill in parts of the 'for' loop to loop over names array */) {
  ...
  for (var i = 0; i < names.length; i++) {
    ...
    // Check the first letter of the name to decide whether to use helloSpeaker or byeSpeaker
    if (firstLetter === 'j') {
